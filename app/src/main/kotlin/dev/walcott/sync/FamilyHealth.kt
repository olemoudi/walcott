...
object FamilyHealth {
     ...
     * time not being counted, the OS not actually suspending what the rules block, a clock that
     * disagrees with the server, an emergency release running, or a device that has gone silent
